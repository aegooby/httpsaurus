...
if (import.meta.main)
{
    yargs.default(args)
        .help(false)
        .command("*", "", {}, Util.exit(CLI.all()))
        .command("clean", "", {}, Util.exit(CLI.clean()))
        .command("install", "", {}, Util.exit(CLI.install()))
        .command("upgrade", "", {}, Util.exit(CLI.upgrade()))
        .command("pkg", "", {}, Util.exit(CLI.pkg()))
        .command("pkg:help", "", {}, Util.exit(CLI.pkg()))
        .command("pkg:add", "", {}, Util.exit(CLI.pkgAdd()))
        .command("pkg:remove", "", {}, Util.exit(CLI.pkgRemove()))
        .command("pkg:update", "", {}, Util.exit(CLI.pkgUpdate()))
        .command("cache", "", {}, Util.exit(CLI.cache()))
        .command("bundle", "", {}, Util.exit(CLI.bundle()))
        .command("bundle:relay", "", {}, Util.exit(CLI.bundleRelay()))
        .command("bundle:snowpack", "", {}, Util.exit(CLI.bundleSnowpack()))
        .command("codegen", "", {}, Util.exit(CLI.codegen()))
        .command("localhost", "", {}, Util.exit(CLI.localhost()))
        .command("localhost:help", "", {}, Util.exit(CLI.localhost()))
        .command("localhost:snowpack", "", {}, Util.exit(CLI.localhostSnowpack()))
        .command("localhost:deno", "", {}, Util.exit(CLI.localhostDeno()))
        .command("deploy", "", {}, Util.exit(CLI.deploy()))
        .command("deploy:help", "", {}, Util.exit(CLI.deploy()))
        .command("deploy:server", "", {}, Util.exit(CLI.deployServer()))
        .command("test", "", {}, Util.exit(CLI.test()))
        .command("docker", "", {}, Util.exit(CLI.docker()))
        .command("docker:help", "", {}, Util.exit(CLI.docker()))
        .command("docker:prune", "", {}, Util.exit(CLI.dockerPrune()))
        .command("docker:image", "", {}, Util.exit(CLI.dockerImage()))
        .command("docker:container", "", {}, Util.exit(CLI.dockerContainer()))
        .command("sync", "", {}, Util.exit(CLI.sync()))
        .command("help", "", {}, Util.exit(CLI.help()))
        .parse();
}
